<template>
   <div class="app">
      ...
      <!--once代表改事件只执行一次-->
<!--      <Student @personalEvent.once="getStudentName" @demo="demo"/>-->
<!--      <Student v-on:personalEvent.once="getStudentName" v-on:demo="demo"/>-->
      <!--第二种写法使用ref绑定事件--->
...
export default {
  ...
  mounted() {
    ...
    // },3000)
    //注意这里回调要写成箭头函数，不然this会丢失(this会指向student的vc),这个this就是(vc)app,而不是(vc)student
